...
extern "C" JNIEXPORT void JNICALL Java_at_bestsolution_fxgl_sample_renderer_internal_RendererAPI_nInitializeLibrary
(JNIEnv *env, jclass)
{
	Renderer::Initialize();
}
extern "C" JNIEXPORT void JNICALL Java_at_bestsolution_fxgl_sample_renderer_internal_RendererAPI_nDisposeLibrary
(JNIEnv *env, jclass)
{
	Renderer::Initialize();
}
...
extern "C" JNIEXPORT void JNICALL Java_at_bestsolution_fxgl_sample_renderer_internal_RendererAPI_nStartRenderer
(JNIEnv *env, jclass, jlong rendererId)
{
	Renderer* renderer = Renderer::GetRenderer(rendererId);
	renderer->Start();
}
extern "C" JNIEXPORT void JNICALL Java_at_bestsolution_fxgl_sample_renderer_internal_RendererAPI_nStopRenderer
(JNIEnv *env, jclass, jlong rendererId)
{
	Renderer* renderer = Renderer::GetRenderer(rendererId);
	renderer->Stop();
}
extern "C" JNIEXPORT void JNICALL Java_at_bestsolution_fxgl_sample_renderer_internal_RendererAPI_nSetTargetFrameRate
(JNIEnv *env, jclass, jlong rendererId, jfloat framerate)
{
	Renderer* renderer = Renderer::GetRenderer(rendererId);
	renderer->SetTargetFramerate(framerate);
}
extern "C" JNIEXPORT void JNICALL Java_at_bestsolution_fxgl_sample_renderer_internal_RendererAPI_nSetRenderTarget
...
extern "C" JNIEXPORT jdouble JNICALL Java_at_bestsolution_fxgl_sample_renderer_internal_RendererAPI_nGetAvgFps
